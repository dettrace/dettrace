...
public:
  ...
  SyscallArgs(unsigned long a0, unsigned long a1, unsigned long a2, unsigned long a3, unsigned long a4, unsigned long a5) {
    args[0] = a0;  args[1] = a1;  args[2] = a2;
    args[3] = a3;  args[4] = a4;  args[5] = a5;
  }
  SyscallArgs(unsigned long a0, unsigned long a1, unsigned long a2, unsigned long a3, unsigned long a4) {
    args[0] = a0;  args[1] = a1;  args[2] = a2;
    args[3] = a3;  args[4] = a4;  args[5] = 0;
  }
  SyscallArgs(unsigned long a0, unsigned long a1, unsigned long a2, unsigned long a3) {
    args[0] = a0;  args[1] = a1;  args[2] = a2;
    args[3] = a3;  args[4] = 0;   args[5] = 0;
  }
  ...
  SyscallArgs(unsigned long a0, unsigned long a1) {
    args[0] = a0;  args[1] = a1;  args[2] = 0;
    args[3] = 0;  args[4] = 0;    args[5] = 0;
  }
  SyscallArgs(unsigned long a0) {
    args[0] = a0;  args[1] = 0;   args[2] = 0;
    args[3] = 0;   args[4] = 0;   args[5] = 0;
  }
  SyscallArgs() {
