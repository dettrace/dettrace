...
static std::string join(std::vector<std::string> vec, const char* delim) {
  ...
  std::copy(
      vec.begin(), vec.end(), std::ostream_iterator<std::string>(res, "\n"));
  return res.str();
}
...
std::string meminfo(void) {
  std::vector<std::string> mi = {
      "MemTotal:       16366972 kB", "MemFree:         5221232 kB",
      "MemAvailable:   15204036 kB", "Buffers:         4037808 kB",
      "Cached:          4162332 kB", "SwapCached:            0 kB",
      "Active:          6616004 kB", "Inactive:        2131092 kB",
      "Active(anon):     536584 kB", "Inactive(anon):      236 kB",
      "Active(file):    6079420 kB", "Inactive(file):  2130856 kB",
      "Unevictable:           0 kB", "Mlocked:               0 kB",
      "SwapTotal:        999420 kB", "SwapFree:         999420 kB",
      "Dirty:                68 kB", "Writeback:             0 kB",
      "AnonPages:        544968 kB", "Mapped:           306652 kB",
      "Shmem:              1692 kB", "Slab:            2197504 kB",
      "SReclaimable:    2104392 kB", "SUnreclaim:        93112 kB",
      "KernelStack:       12528 kB", "PageTables:        24900 kB",
      "NFS_Unstable:          0 kB", "Bounce:                0 kB",
      "WritebackTmp:          0 kB", "CommitLimit:     9182904 kB",
      "Committed_AS:    5592004 kB", "VmallocTotal:   34359738367 kB",
      "VmallocUsed:           0 kB", "VmallocChunk:          0 kB",
      "HardwareCorrupted:     0 kB", "AnonHugePages:         0 kB",
      "ShmemHugePages:        0 kB", "ShmemPmdMapped:        0 kB",
      "CmaTotal:              0 kB", "CmaFree:               0 kB",
      "HugePages_Total:       0",    "HugePages_Free:        0",
      "HugePages_Rsvd:        0",    "HugePages_Surp:        0",
      "Hugepagesize:       2048 kB", "DirectMap4k:      309996 kB",
      "DirectMap2M:     6971392 kB", "DirectMap1G:    10485760 kB",
  };
  return join(mi, "\n");
}
...
std::string stat(void) {
  ...
  snprintf(
      line, 4096, "cpu %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu\n",
  ...
  for (int i = 1; i <= ncpus; i++) {
    snprintf(
        line, 4096, "cpu%d %lu %lu %lu %lu %lu %lu %lu %lu %lu %lu\n", i - 1,
